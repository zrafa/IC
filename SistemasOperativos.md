...
Una vez que el programa está en ejecución, decimos que tenemos un nuevo **proceso** en el sistema. Este nuevo proceso es un **hijo** del shell, y a su vez puede crear nuevos procesos hijos si es necesario.
...
Los sistemas **de tiempo compartido** están diseñados para ser **interactivos**, y tienen la misión de hacer creer a cada usuario que el sistema de cómputo está dedicado exclusivamente a sus procesos.  
...
###Ciclo en un sistema multiprogramado
...
###Ciclo en un sistema de tiempo compartido
...
- Al entregar la CPU a un proceso que pasa de listo a ejecutando, el SO pone en marcha un reloj para medir un quantum de tiempo que pasará ejecutando el proceso.
...
- La **prioridad** a la cual está ejecutando y el **valor de nice**
