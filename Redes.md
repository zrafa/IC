...
En una red conmutada por paquetes, los nodos intermedios no necesitan conocer todo el camino que debe atravesar cada uno de los paquetes. En cambio, un router sólo necesita saber a cuál de los nodos intermedios adyacentes encaminarlos, basándose en información que transporta el mismo paquete. Cada nodo intermedio o router en un camino entre emisor y receptor toma una nueva decisión de ruteo ante cada uno de los paquetes que llegan a él.



Para que los paquetes puedan ser encaminados, el emisor completa los datos que constituyen el paquete con un **encabezado** conteniendo la dirección del nodo emisor, o **dirección origen**, y la dirección del nodo destino, o **dirección destino**.


##Ruteo o encaminamiento
Cuando un paquete llega a un router, lo hace por un enlace. El router debe aplicar alguna regla para saber hacia qué otro enlace **reenviar** el paquete. Esta decisión de cuál será ese otro enlace es una acción de **ruteo** o **encaminamiento**.
